var fadeStart=100 // 100px scroll or less will equiv to 1 opacity
    ...
    fadeStart2=4000 // 100px scroll or less will equiv to 1 opacity
    ,fadeUntil2=8000 // 200px scroll or more will equiv to 0 opacity
    ,fading2 = $('#fading2')

    fadeStart3=8000 // 100px scroll or less will equiv to 1 opacity
    ,fadeUntil3=12000 // 200px scroll or more will equiv to 0 opacity
    ,fading3 = $('#fading3')

    fadeStart4=12000 // 100px scroll or less will equiv to 1 opacity
    ,fadeUntil4=16000 // 200px scroll or more will equiv to 0 opacity
    ,fading4 = $('#fading4')

    fadeStart5=16000 // 100px scroll or less will equiv to 1 opacity
    ,fadeUntil5=20000 // 200px scroll or more will equiv to 0 opacity
    ,fading5 = $('#fading5')

    fadeStart6=20000 // 100px scroll or less will equiv to 1 opacity
    ,fadeUntil6=24000 // 200px scroll or more will equiv to 0 opacity
    ,fading6 = $('#fading6')

    fadeStart7=24000 // 100px scroll or less will equiv to 1 opacity
    ,fadeUntil7=28000 // 200px scroll or more will equiv to 0 opacity
    ,fading7 = $('#fading7')

    fadeStart8=28000 // 100px scroll or less will equiv to 1 opacity
